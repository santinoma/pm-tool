...
export async function DELETE(_request: Request, { params }: { params: Promise<{ id: string; dependencyId: string }> }) {
  ...
  await context.tenantDb.taskDependency.delete({ where: { id: dependencyId } });
